...
from app.common.constants import EXCEPT_PATH_LIST, EXCEPT_PATH_REGEX
from app.database.connections import db
from app.database.schema import User, ApiKeys
from app.errors import exceptions as ex

from app.common import config, constants
...
async def token_decode(access_token):
    ...
    try:
        ...
        payload = jwt.decode(access_token, key=constants.JWT_SECRET, algorithms=[constants.JWT_ALGORITHM])
